...
MdTable::MdTable (void)
{
	...
	declare_prop_fn (me, "chunks_used", (get_uint64_t) ([&](){ return chunks_used; }), "desc of chunks_used", 0);
	...
	declare_prop_fn (me, "raid_disks",  (get_int32_t)  ([&](){ return raid_disks;  }), "desc of raid_disks",  0);
	declare_prop_fn (me, "raid_layout", (get_int32_t)  ([&](){ return raid_layout; }), "desc of raid_layout", 0);
	declare_prop_fn (me, "raid_type",   (get_int32_t)  ([&](){ return raid_type;   }), "desc of raid_type",   0);
	declare_prop_fn (me, "vol_name",    (get_string_t) ([&](){ return vol_name;    }), "desc of vol_name",    0);
	declare_prop_fn (me, "vol_uuid",    (get_string_t) ([&](){ return vol_uuid;    }), "desc of vol_uuid",    0);
}
