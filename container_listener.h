...
public:
	...
	virtual void container_added   (const ContainerPtr& child) = 0;
	virtual void container_changed (const ContainerPtr& after) = 0;
	virtual void container_deleted (const ContainerPtr& child) = 0;
};
