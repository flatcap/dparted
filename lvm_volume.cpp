...
LvmVolume::LvmVolume (void)
{
	...
	declare_prop (me, "stripes",      stripes,      "desc of stripes");
	declare_prop (me, "stripesize",   stripesize,   "desc of stripesize");
	declare_prop (me, "stripe_size",  stripe_size,  "desc of stripe_size");
