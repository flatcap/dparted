...
public:
	...
	virtual void gfx_container_added   (const GfxContainerPtr& child) = 0;
	virtual void gfx_container_changed (const GfxContainerPtr& after) = 0;
	virtual void gfx_container_deleted (const GfxContainerPtr& child) = 0;
};
