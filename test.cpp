...
test_execute_add (ContainerPtr& child)
{
	...
	log_info ("ADD parent %s(%p), child %s(%p)", parent->get_name_default().c_str(), VP(parent), child->get_name_default().c_str(), VP(child));
...
test_execute_delete (ContainerPtr& child)
{
	...
	log_info ("DELETE parent %s(%p), child %s(%p)", parent->get_name_default().c_str(), VP(parent), child->get_name_default().c_str(), VP(child));
...
test_execute_move (ContainerPtr& child)
{
	...
	log_info ("MOVE parent %s(%p), child %s(%p)", parent->get_name_default().c_str(), VP(parent), child->get_name_default().c_str(), VP(child));
...
test_execute_resize (ContainerPtr& child)
{
	...
	log_info ("RESIZE parent %s(%p), child %s(%p)", parent->get_name_default().c_str(), VP(parent), child->get_name_default().c_str(), VP(child));
