...
LuksTable::LuksTable (void)
{
	...
	declare_prop_var (me, "cipher_mode", cipher_mode, "desc of cipher_mode", 0);
	declare_prop_var (me, "cipher_name", cipher_name, "desc of cipher_name", 0);
	declare_prop_var (me, "hash_spec",   hash_spec,   "desc of hash_spec",   0);
	declare_prop_var (me, "version",     version,     "desc of version",     0);
}
